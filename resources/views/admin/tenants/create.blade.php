    ...
    <div class="mx-auto my-8 max-w-4xl px-4">
        ...
        <form action="{{ route('admin.tenants.store') }}" method="POST" class="bg-white p-6 rounded shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="host" id="host" class="w-full border-gray-300 rounded p-2" value="127.0.0.1">
            </div>
            <div class="mb-4">
                <label for="port" class="block text-gray-700">Port</label>
                <input type="text" name="port" id="port" class="w-full border-gray-300 rounded p-2" value="3306">
            </div>
            <div class="mb-4">
