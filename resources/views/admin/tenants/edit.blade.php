    ...
    <div class="mx-auto my-8 max-w-4xl px-4">
        ...
        <form action="{{ route('admin.tenants.update', $tenant) }}" method="POST" class="bg-white p-6 rounded shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" class="w-full border-gray-300 rounded p-2" value="{{ $tenant->password }}" placeholder="Leave blank to keep current password">
            </div>
